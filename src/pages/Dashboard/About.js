...
import { getAllAbout, updateAbout } from '../../api';
...
const About = () => {
    ...
    return (
        <div className="dashboard-wrapper d-flex">
            <HelmetSection title="About | LeedWay" />
            <Sidebar />
                ...
                <header className="d-flex align-items-center justify-content-between p-4 ">
                    ...
                    {loggedInUser.email ? (
                        <div>
                            ...
                            <span className="border border-success p-1 rounded">
