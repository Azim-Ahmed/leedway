...
import { getAllConstruction, updateConstruction } from '../../api';
import { Button, Table } from 'react-bootstrap';
import NewModal from '../../components/ReusableComponent/Modal'
const AdConstruction = () => {
    ...
    useEffect(async () => {
        ...
        setConstructionData(data.construction);
        setLoading(false);
    }, []);
    ...
    const renderModal = () => {
        return (
            <NewModal
                ...
                modalTitle={`Construction Page Update`}
            >
                {renderForm()}
            </NewModal>
        )
    ...
    return (
        <div className="dashboard-wrapper d-flex">
            <HelmetSection title="Construction | LeedWay" />
            <Sidebar />
